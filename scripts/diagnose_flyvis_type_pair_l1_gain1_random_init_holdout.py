...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Random-initialization hold-out of L1 mean gain 1 versus standard gain 3, "
            "testing whether the biological-init gain correction generalizes"
        )
    )
