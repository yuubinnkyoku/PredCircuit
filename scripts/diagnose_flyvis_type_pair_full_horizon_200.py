...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Extend the epoch-0 full-horizon rule holdout to 200 epochs to test whether "
            "shared-credit accuracy peaks saturate, reverse, or diverge."
        )
    )
