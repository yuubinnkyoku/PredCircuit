...
INIT_SCALE = 0.115
FORK_EPOCHS = (80, 120, 140)
END_EPOCH = 200
EVAL_REPS = 4
EVAL_JITTER_BASE = 145_000_000
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Fresh early common-state fork hold-out localizing when type-pair selective "
            "attenuation gains an advantage over globally L2-matched attenuation."
        )
    )
