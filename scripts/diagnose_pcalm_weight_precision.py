...
def dead_update_rate(
    model: WeightQuantizedResidualMLP, grads: list[torch.Tensor], lr: float
) -> float:
        ...
        rows.append(
            {
                ...
                "weight_saturation_rate": model.weight_saturated / model.weight_total
                if model.weight_total
                else 0.0,
