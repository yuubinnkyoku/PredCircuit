    ...
    *,
    ...
    for epoch in range(100):
        ...
        if BURST_START <= epoch < BURST_END:
            directions = {}
            for suffix in ("endogenous", "swapped"):
            ...
            directions = {
                "type_endogenous": own_edges["type_endogenous"],
                "shuffle_endogenous": own_edges["shuffle_endogenous"],
                "type_swapped": own_edges["shuffle_swapped"],
                "shuffle_swapped": own_edges["type_swapped"],
            }
        else:
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Swap type and shuffled local-credit fields after the matched 50-epoch burst"
    )
